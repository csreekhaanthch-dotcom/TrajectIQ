          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="relative h-10 w-10">
                <div className="h-full w-full bg-gradient-to-br from-primary to-teal-600 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-lg">TIQ</span>
                </div>
              </div>
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-muted-foreground -mt-0.5">Intelligence-Driven Hiring</p>
              </div>
            </div>
