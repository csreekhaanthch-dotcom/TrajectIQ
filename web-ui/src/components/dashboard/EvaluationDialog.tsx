            ...
            {error && (
              <div className="flex flex-col gap-3 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-destructive">Evaluation Failed</h4>
                    <p className="text-sm text-muted-foreground mt-0.5">{error}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-xs text-muted-foreground pl-13">
                  <Info className="h-3 w-3" />
                  <span>Please check your input and try again. If the problem persists, contact support.</span>
                </div>
              </div>
            )}
            ...
            {!result && (
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 hover:from-blue-500 hover:via-blue-400 hover:to-cyan-400 text-white font-medium shadow-lg shadow-blue-500/25 transition-all duration-300"
                >
                  {isEvaluating ? (
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-[10px] text-blue-200">Running AI analysis modules</span>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2">
                ...
                {!resumeContent.trim() && (
                  <p className="text-xs text-muted-foreground text-center">
                    Please enter resume content to start evaluation
                  </p>
                )}
              </div>
            )}
